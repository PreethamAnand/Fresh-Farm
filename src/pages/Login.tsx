        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="mt-6 space-y-4">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <button
                type="button"
                onClick={() => toast({ title: "Reset link sent", description: "Check your inbox to continue." })}
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => toast({ title: "Google sign-in", description: "OAuth flow can be added here." })}
              ...
              <button
                type="button"
                onClick={() => toast({ title: "Phone sign-in", description: "OTP flow can be added here." })}
                className="py-2.5 rounded-xl border border-border bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors"
              >
                Phone
              </button>
